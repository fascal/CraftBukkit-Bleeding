...
final class DispenseBehaviorTNT extends DispenseBehaviorItem {
    ...
    protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        // CraftBukkit start
        double i = isourceblock.getBlockX() + enumfacing.c(); // int -> double
        double j = isourceblock.getBlockY() + enumfacing.d(); // int -> double
        double k = isourceblock.getBlockZ() + enumfacing.e(); // int -> double
