    ...
    public boolean a(ItemStack itemstack, EntityHuman entityhuman, EntityLiving entityliving) {
        if (entityliving instanceof EntitySheep) {
            ...
            if (!entitysheep.isSheared() && entitysheep.getColor() != i) {
                // CraftBukkit start
                byte bColor = (byte) i;
                SheepDyeWoolEvent event = (SheepDyeWoolEvent) new org.bukkit.event.entity.EntityDyeEvent((org.bukkit.entity.Sheep) entitysheep.getBukkitEntity(), entityhuman.getBukkitEntity(), org.bukkit.DyeColor.getByData(bColor));
